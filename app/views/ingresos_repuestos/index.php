...
<head>
    ...
    <title>PhoneControl &mdash; Ingreso de repuestos</title>
    ...
    <div class="main-wrapper">
        ...
        <header class="topbar">
            <div class="topbar-left">
                <h5 class="topbar-title mb-0">Ingreso de repuestos</h5>
                <p class="topbar-date mb-0">Entradas de repuestos al inventario</p>
            </div>
        ...
        <main class="main-content">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 d-flex align-items-center justify-content-between pt-3 pb-2 gap-2 flex-wrap">
                    <h6 class="card-title mb-0 fw-semibold">Historial de ingresos de repuestos</h6>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-5">
                                        ...
                                        No hay ingresos de repuestos registrados para esta sucursal.
                                    </td>
                                </tr>
                                <?php else: ?>
                                ...
                                <tr <?= $rowBg ?>>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <?php if (!$esTransfer): ?>
                                            <a href="<?= BASE_URL ?>/ingresos-repuestos/eliminar?id=<?= $ing['id'] ?>&vet=<?= $veterinaria_id ?>"
                                               class="btn btn-sm btn-outline-danger btn-accion"
                                               title="Eliminar (revierte stock)"
                                               onclick="return confirm('¿Eliminar este ingreso? Se revertirá el stock de todos sus repuestos.')">
...
<div class="modal fade" id="modalIngreso" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow">
            <form method="POST" action="<?= BASE_URL ?>/ingresos-repuestos/registrar" id="formIngreso">
                ...
                <div class="modal-body pt-2">
                    ...
                    <div id="msgSinLineas" class="linea-empty">
                        <i class="bi bi-cpu"></i>
                        <span>Haz clic en <strong>Agregar repuesto</strong> para comenzar.</span>
                    </div>
...
<script src="<?= BASE_URL ?>/assets/js/ingresos_repuestos.js"></script>
<script>
(function () {
