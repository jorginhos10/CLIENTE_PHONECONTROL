...
<head>
    ...
    <title>PhoneControl &mdash; Repuestos</title>
    ...
    <div class="main-wrapper">
        ...
        <header class="topbar">
            <div class="topbar-left">
                <h5 class="topbar-title mb-0">Repuestos</h5>
                <p class="topbar-date mb-0">Gestión de repuestos e inventario</p>
            </div>
        ...
        <main class="main-content">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 d-flex align-items-center justify-content-between pt-3 pb-2 gap-2">
                    <h6 class="card-title mb-0 fw-semibold">Repuestos en inventario</h6>
                    <div class="d-flex gap-2 align-items-center">
                        <input type="text" class="form-control form-control-sm" id="buscador" placeholder="Buscar repuesto..." style="width:200px;">
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" id="tablaProductos">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                <?php foreach ($repuestos as $i => $p): ?>
                                <?php $bloqueado = !(bool)$p['activo']; ?>
                                <tr class="<?= $bloqueado ? 'fila-bloqueada' : '' ?>">
                                    <td class="ps-3 text-muted small"><?= $i + 1 ?></td>
                                    <td>
                                        <?php if (!empty($p['imagen'])): ?>
                                        <img src="<?= BASE_URL ?>/assets/img/repuestos/<?= htmlspecialchars($p['imagen']) ?>"
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <?php endif; ?>
                                            <a href="<?= BASE_URL ?>/repuestos/toggle?id=<?= $p['id'] ?>"
...
<div class="modal fade" id="modalAgregarProducto" tabindex="-1" aria-labelledby="modalAgregarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form method="POST" action="<?= BASE_URL ?>/repuestos/agregar" id="formProducto" enctype="multipart/form-data">
                ...
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-bold" id="modalAgregarLabel">
                        ...
                        <span id="modalTitulo">Agregar repuesto</span>
                    </h5>
                ...
                <div class="modal-body pt-3">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-semibold">Nombre del repuesto <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="nombre" id="inp-nombre" placeholder="Ej: Pantalla iPhone 12" required>
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-semibold">Foto del repuesto</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="codigo" id="inp-codigo"
                                placeholder="Ej: REP-001, PANT-042…">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Se usa para buscar el repuesto en el punto de venta.</div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="descripcion" id="inp-descripcion" rows="2"
                                placeholder="Descripción opcional del repuesto…"></textarea>
                        </div>
...
// Nuevo repuesto: limpia el modal
function nuevoProducto() {
    document.getElementById('modalTitulo').textContent = 'Agregar repuesto';
    document.getElementById('formProducto').action = '<?= BASE_URL ?>/repuestos/agregar';
...
// Editar repuesto: rellena el modal con los datos existentes
function editarProducto(p) {
    document.getElementById('modalTitulo').textContent = 'Editar repuesto';
    document.getElementById('formProducto').action = '<?= BASE_URL ?>/repuestos/agregar?id=' + p.id;
    ['nombre','codigo','codigo_barras','descripcion','categoria_id','unidad','precio_compra','precio_venta','stock_minimo','stock'].forEach(campo => {
        const el = document.getElementById('inp-' + campo);
        if (el) el.value = p[campo] ?? '';
    });
    document.getElementById('inp-imagen').value = '';
    mostrarPreviewImagen(p.imagen ? '<?= BASE_URL ?>/assets/img/repuestos/' + p.imagen : '');
...
<div class="modal fade" id="modalTransferir" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow">
            <form method="POST" action="<?= BASE_URL ?>/repuestos/transferir">
                ...
                <div class="modal-body pt-3">
                    ...
                    <div class="alert alert-light border py-2 small mb-3">
                        <div class="text-muted mb-1">Repuesto:</div>
